...
#AVG = r"D:\plantclef2024\embedsv2\avg_all.pt"
...
def data_loader(embeds, labels):
    ...
    for i in tqdm.tqdm(range(0, batch_size)):
        ...
        img = Image.fromarray(np.uint8(patch)) # remove 255 (why was that there in the first place)
        ...
        embeds.append(torch.tensor(output))
