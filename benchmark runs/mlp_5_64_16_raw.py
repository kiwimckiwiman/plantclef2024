...
def plsplsplsplspls(process):
    ...
    for image in patch_batch[int(process)]:
        ...
        print("====================================")
        print(f"{process} | Now predicting {image} both 64 & 16 raw| {count} of {1695/5} | MLP 5 | 64")
        for patch in os.listdir(folder64):
            ...
            mlp_1_predictions = mlp_pred(embed, mlp5)
            mlp_1_scores = []
        ...
        print("====================================")
        print(f"{process} | Now predicting {image} both 64 & 16 raw| {count} of {1695/5} | MLP 5 | 16")
    ...
    file_name = "mlp_5_64_16_raw" + str(process) + ".csv"
