...
def plsplsplsplspls(process):
    ...
    for image in patch_batch[int(process)]:
        ...
        print("====================================")
        print(f"{process} | Now predicting {image} both 64 & 16 raw| {count} of {1695/5} | MLP 1 | 64")
        ...
        print("====================================")
        print(f"{process} | Now predicting {image} both 64 & 16 raw| {count} of {1695/5} | MLP 1 | 16")
    ...
    file_name = "mlp_1_64_16_raw" + str(process) + ".csv"
