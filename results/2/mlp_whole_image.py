...
RESULTS = r"C:\Users\ASUS\Desktop\miniclef\code\benchmarks\results\2\mlp_whole_image_top_50.csv"
FILTERED = r"C:\Users\ASUS\Desktop\miniclef\code\benchmarks\results\2\filtered_bench_2.csv"
MLP_PATH = r"C:\Users\ASUS\Desktop\miniclef\code\benchmarks\results\2\mlp_run_6_0.05_100_single_class.pth"
...
for img_name in tqdm(os.listdir(TEST_IMGS)):
    ...
    for i in range(50):
        predictions.append([cid_to_spid[sorted_indexes[i]], softmax_arr[i]])
...
for preds in all_pred:
    ...
    filtered.append([preds[0], fil_lab])
